      ...
      <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark">
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="mr-auto">
            <NavDropdown style={{color:'black',backgroundColor:'#fff'}} title="Products" id="collasible-nav-dropdown">
            ...
            <Nav.Link><Link style={{textDecoration:'none',color:'white'}} to='/OrderHistory'>Order History</Link></Nav.Link>
          </Nav>
          <Nav>
          <Nav.Link><Link style={{textDecoration:'none',color:'white'}} to='/Cart'><FiShoppingCart size='15px'/></Link></Nav.Link>
          <Nav.Link><Link style={{textDecoration:'none',color:'white'}} to='/Signup'>Sign Up</Link></Nav.Link>
